    ...
    <section id="product" className={layout.sectionReverse}>
        ...
        <div className={layout.sectionInfo}>
          ...
          <div className="flex flex-row flex-wrap sm:mt-10 mt-6">
            <img src={apple} alt="applestore" className='w-[128px] h-[42px] objectcontain mr-5 cursor-pointer' />
            <img src={google} alt="googlestore" className='w-[128px] h-[42px] objectcontain mr-5 cursor-pointer' />
